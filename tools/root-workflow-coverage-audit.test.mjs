...
function runtimeNames(workflow) { return workflow.runtimeEvidenceResults.map((result) => result.name).filter((name) => name !== "student_app_ai_tutor_controlled_answer_artifact_runtime" && name !== "student_app_ai_tutor_answer_review_gate_runtime"); }
