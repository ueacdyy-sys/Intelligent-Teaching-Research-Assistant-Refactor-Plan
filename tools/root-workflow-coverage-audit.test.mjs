...
describe("root workflow coverage audit", () => {
  it("passes when every immutable-root workflow has current evidence", () => {
    ...
    assertRuntimeAfter(teaching, "student_app_ai_tutor_result_student_archive_storage_commit_runtime", "student_app_ai_tutor_result_student_archive_row_verification_runtime");
    assertReportPassed(teaching, "studentAppAiTutorResultStudentArchiveRowVerification");
    assertRuntimeAfter(teaching, "student_app_ai_tutor_result_student_archive_row_verification_runtime", "student_app_ai_tutor_result_student_archive_read_runtime");
    assertReportPassed(teaching, "studentAppAiTutorResultStudentArchiveRead");
    assertRuntimeAfter(teaching, "student_app_ai_tutor_result_student_archive_read_runtime", "student_app_ai_tutor_result_student_archive_render_runtime");
    assertReportPassed(teaching, "studentAppAiTutorResultStudentArchiveRender");
    assertRuntimeAfter(teaching, "student_app_ai_tutor_result_student_archive_render_runtime", "student_app_ai_tutor_result_student_archive_learning_actions_runtime");
    assertReportPassed(teaching, "studentAppAiTutorResultStudentArchiveLearningActions");
    assertRuntimeAfter(teaching, "student_app_ai_tutor_result_student_archive_learning_actions_runtime", "student_app_ai_tutor_worker_result_archive_input");
    assertReportPassed(teaching, "studentAppAiTutorWorkerResultArchiveInput");
    assertRuntimeAfter(teaching, "student_app_ai_tutor_worker_result_archive_input", "student_app_ai_tutor_result_archive_model_execution_precheck");
    assertReportPassed(teaching, "studentAppAiTutorResultArchiveModelExecutionPrecheck");
    assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_model_execution_precheck", "student_app_ai_tutor_result_archive_controlled_answer_artifact"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveControlledAnswerArtifact"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_controlled_answer_artifact", "student_app_ai_tutor_result_archive_answer_review_gate"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveAnswerReviewGate"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_answer_review_gate", "student_app_ai_tutor_result_archive_reviewed_result_persistence_bridge"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveReviewedResultPersistenceBridge"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_reviewed_result_persistence_bridge", "student_app_ai_tutor_result_archive_student_visibility_review"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveStudentVisibilityReview"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_student_visibility_review", "student_app_ai_tutor_result_archive_student_delivery_envelope"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveStudentDeliveryEnvelope"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_student_delivery_envelope", "student_app_ai_tutor_result_archive_student_archive_persistence_command"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveStudentArchivePersistenceCommand"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_student_archive_persistence_command", "student_app_ai_tutor_result_archive_student_archive_storage_commit"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveStudentArchiveStorageCommit"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_student_archive_storage_commit", "student_app_ai_tutor_result_archive_student_archive_row_verification"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveStudentArchiveRowVerification"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_student_archive_row_verification", "student_app_ai_tutor_result_archive_student_archive_read"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveStudentArchiveRead"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_student_archive_read", "student_app_ai_tutor_result_archive_student_archive_render"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveStudentArchiveRender"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_student_archive_render", "student_app_ai_tutor_result_archive_student_archive_learning_actions"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveStudentArchiveLearningActions"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_student_archive_learning_actions", "student_app_ai_tutor_result_archive_follow_up_queue_admission"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveFollowUpQueueAdmission"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_follow_up_queue_admission", "student_app_ai_tutor_result_archive_follow_up_worker_continuity"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveFollowUpWorkerContinuity"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_follow_up_worker_continuity", "student_app_ai_tutor_result_archive_follow_up_depth_budget_guard"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveFollowUpDepthBudgetGuard"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_follow_up_depth_budget_guard", "student_app_ai_tutor_result_archive_follow_up_queue_idempotency_guard"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveFollowUpQueueIdempotencyGuard"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_follow_up_queue_idempotency_guard", "student_app_ai_tutor_result_archive_follow_up_lineage_guard"); assertReportPassed(teaching, "studentAppAiTutorResultArchiveFollowUpLineageGuard"); assertRuntimeAfter(teaching, "student_app_ai_tutor_result_archive_follow_up_lineage_guard", "student_app_ai_tutor_request_progress_timeline"); assertReportPassed(teaching, "studentAppAiTutorRequestProgressTimeline"); assertRuntimeAfter(teaching, "student_app_ai_tutor_request_progress_timeline", "student_app_ai_tutor_request_progress_detail"); assertReportPassed(teaching, "studentAppAiTutorRequestProgressDetail"); assertRuntimeAfter(teaching, "student_app_ai_tutor_request_progress_detail", "student_app_ai_tutor_request_progress_primary_action"); assertReportPassed(teaching, "studentAppAiTutorRequestProgressPrimaryAction"); assertRuntimeAfter(teaching, "student_app_ai_tutor_request_progress_primary_action", "student_app_ai_tutor_request_progress_target_url"); assertReportPassed(teaching, "studentAppAiTutorRequestProgressTargetURL"); assertRuntimeAfter(teaching, "student_app_ai_tutor_request_progress_target_url", "student_app_ai_tutor_request_progress_refresh_policy"); assertReportPassed(teaching, "studentAppAiTutorRequestProgressRefreshPolicy"); assertRuntimeAfter(teaching, "student_app_ai_tutor_request_progress_refresh_policy", "student_app_ai_tutor_request_progress_conditional_cache"); assertReportPassed(teaching, "studentAppAiTutorRequestProgressConditionalCache");
    const studentTutor = workflowById(report, "student_app_personalized_learning");
    assert.deepEqual(runtimeNames(studentTutor), "student_tutor_agent_readonly_runtime_slo student_tutor_agent_readonly_runtime_adapter student_app_ai_tutor_request_runtime student_app_ai_tutor_published_learning_action_source student_app_ai_tutor_worker_study_packet_input student_app_ai_tutor_model_execution_precheck_runtime student_app_ai_tutor_result_archive_student_visibility_review student_app_ai_tutor_result_archive_student_delivery_envelope student_app_ai_tutor_result_archive_student_archive_persistence_command student_app_ai_tutor_result_archive_student_archive_storage_commit student_app_ai_tutor_result_archive_student_archive_row_verification student_app_ai_tutor_result_archive_student_archive_read student_app_ai_tutor_result_archive_student_archive_render student_app_ai_tutor_result_archive_student_archive_learning_actions student_app_ai_tutor_result_archive_follow_up_queue_admission student_app_ai_tutor_result_archive_follow_up_worker_continuity student_app_ai_tutor_result_archive_follow_up_depth_budget_guard student_app_ai_tutor_result_archive_follow_up_queue_idempotency_guard student_app_ai_tutor_result_archive_follow_up_lineage_guard student_app_ai_tutor_request_progress_timeline student_app_ai_tutor_request_progress_detail student_app_ai_tutor_request_progress_primary_action student_app_ai_tutor_request_progress_target_url student_app_ai_tutor_request_progress_refresh_policy student_app_ai_tutor_request_progress_conditional_cache student_app_ai_tutor_worker_claim_runtime student_app_ai_tutor_result_runtime student_app_ai_tutor_question_bank_draft_generation_plan_runtime student_app_ai_tutor_question_bank_draft_generation_worker_claim_precheck_runtime student_app_ai_tutor_question_bank_draft_generation_worker_claim_runtime student_app_ai_tutor_question_bank_draft_generation_input_envelope_runtime student_app_ai_tutor_question_bank_draft_generation_model_execution_precheck_runtime student_app_ai_tutor_question_bank_draft_generation_controlled_draft_runtime student_app_ai_tutor_question_bank_draft_generation_teacher_review_runtime student_app_ai_tutor_question_bank_draft_generation_content_storage_commit_runtime student_app_ai_tutor_question_bank_draft_generation_content_row_verification_runtime student_app_ai_tutor_question_bank_draft_visibility_runtime student_app_ai_tutor_question_bank_draft_content_precheck_runtime student_app_ai_tutor_question_bank_draft_content_read_foundation student_app_ai_tutor_question_bank_draft_content_student_read_verification_runtime student_app_ai_tutor_question_bank_draft_answer_submission_foundation student_app_ai_tutor_question_bank_draft_answer_submission_verification_runtime student_app_ai_tutor_question_bank_draft_answer_scoring_request_foundation student_app_ai_tutor_question_bank_draft_answer_scoring_request_verification_runtime student_app_ai_tutor_question_bank_draft_answer_scoring_input_foundation student_app_ai_tutor_question_bank_draft_answer_scoring_model_execution_precheck_runtime student_app_ai_tutor_question_bank_draft_answer_controlled_scoring_artifact_runtime student_app_ai_tutor_question_bank_draft_answer_scoring_result_persistence_bridge_runtime student_app_ai_tutor_question_bank_draft_answer_scoring_result_foundation student_app_ai_tutor_question_bank_draft_answer_scoring_completion_bridge student_app_ai_tutor_question_bank_draft_answer_feedback_publication_precheck_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_generation_model_execution_precheck_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_controlled_draft_runtime student_app_ai_tutor_question_bank_draft_answer_reviewed_feedback_artifact_controlled_draft_source_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_publication_approval_controlled_draft_source_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_delivery_envelope_controlled_draft_source_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_archive_persistence_command_controlled_draft_source_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_archive_storage_commit_controlled_draft_source_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_archive_row_verification_controlled_draft_source_runtime student_app_ai_tutor_question_bank_draft_answer_reviewed_feedback_artifact_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_publication_approval_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_delivery_envelope_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_archive_persistence_command_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_archive_storage_commit_runtime student_app_ai_tutor_question_bank_draft_answer_feedback_archive_row_verification_runtime teaching_archive_material_draft_student_product_read_runtime teaching_archive_material_publication_precheck_runtime teaching_archive_material_publication_approval_runtime teaching_archive_material_publication_delivery_runtime teaching_archive_material_publication_persistence_command_runtime teaching_archive_material_publication_storage_commit_runtime teaching_archive_material_publication_row_verification_runtime teaching_archive_material_publication_student_app_read_runtime teaching_archive_material_publication_projection_hardening_runtime teaching_archive_material_published_search_foundation_runtime teaching_archive_material_published_detail_metadata_read_runtime teaching_archive_material_published_content_preview_precheck_runtime teaching_archive_material_published_content_preview_read_foundation teaching_archive_material_published_content_preview_render_envelope teaching_archive_material_published_study_packet teaching_archive_material_published_learning_actions".split(" "));
    ...
    assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_student_archive_storage_commit_runtime", "student_app_ai_tutor_result_student_archive_row_verification_runtime");
    assertReportPassed(studentTutor, "studentAppAiTutorResultStudentArchiveRowVerification");
    assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_student_archive_row_verification_runtime", "student_app_ai_tutor_result_student_archive_read_runtime");
    assertReportPassed(studentTutor, "studentAppAiTutorResultStudentArchiveRead");
    assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_student_archive_read_runtime", "student_app_ai_tutor_result_student_archive_render_runtime");
    assertReportPassed(studentTutor, "studentAppAiTutorResultStudentArchiveRender");
    assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_student_archive_render_runtime", "student_app_ai_tutor_result_student_archive_learning_actions_runtime");
    assertReportPassed(studentTutor, "studentAppAiTutorResultStudentArchiveLearningActions");
    assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_student_archive_learning_actions_runtime", "student_app_ai_tutor_worker_result_archive_input");
    assertReportPassed(studentTutor, "studentAppAiTutorWorkerResultArchiveInput");
    assertRuntimeAfter(studentTutor, "student_app_ai_tutor_worker_result_archive_input", "student_app_ai_tutor_result_archive_model_execution_precheck");
    assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveModelExecutionPrecheck");
    assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_model_execution_precheck", "student_app_ai_tutor_result_archive_controlled_answer_artifact"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveControlledAnswerArtifact"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_controlled_answer_artifact", "student_app_ai_tutor_result_archive_answer_review_gate"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveAnswerReviewGate"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_answer_review_gate", "student_app_ai_tutor_result_archive_reviewed_result_persistence_bridge"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveReviewedResultPersistenceBridge"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_reviewed_result_persistence_bridge", "student_app_ai_tutor_result_archive_student_visibility_review"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveStudentVisibilityReview"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_student_visibility_review", "student_app_ai_tutor_result_archive_student_delivery_envelope"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveStudentDeliveryEnvelope"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_student_delivery_envelope", "student_app_ai_tutor_result_archive_student_archive_persistence_command"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveStudentArchivePersistenceCommand"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_student_archive_persistence_command", "student_app_ai_tutor_result_archive_student_archive_storage_commit"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveStudentArchiveStorageCommit"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_student_archive_storage_commit", "student_app_ai_tutor_result_archive_student_archive_row_verification"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveStudentArchiveRowVerification"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_student_archive_row_verification", "student_app_ai_tutor_result_archive_student_archive_read"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveStudentArchiveRead"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_student_archive_read", "student_app_ai_tutor_result_archive_student_archive_render"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveStudentArchiveRender"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_student_archive_render", "student_app_ai_tutor_result_archive_student_archive_learning_actions"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveStudentArchiveLearningActions"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_student_archive_learning_actions", "student_app_ai_tutor_result_archive_follow_up_queue_admission"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveFollowUpQueueAdmission"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_follow_up_queue_admission", "student_app_ai_tutor_result_archive_follow_up_worker_continuity"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveFollowUpWorkerContinuity"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_follow_up_worker_continuity", "student_app_ai_tutor_result_archive_follow_up_depth_budget_guard"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveFollowUpDepthBudgetGuard"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_follow_up_depth_budget_guard", "student_app_ai_tutor_result_archive_follow_up_queue_idempotency_guard"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveFollowUpQueueIdempotencyGuard"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_follow_up_queue_idempotency_guard", "student_app_ai_tutor_result_archive_follow_up_lineage_guard"); assertReportPassed(studentTutor, "studentAppAiTutorResultArchiveFollowUpLineageGuard"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_result_archive_follow_up_lineage_guard", "student_app_ai_tutor_request_progress_timeline"); assertReportPassed(studentTutor, "studentAppAiTutorRequestProgressTimeline"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_request_progress_timeline", "student_app_ai_tutor_request_progress_detail"); assertReportPassed(studentTutor, "studentAppAiTutorRequestProgressDetail"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_request_progress_detail", "student_app_ai_tutor_request_progress_primary_action"); assertReportPassed(studentTutor, "studentAppAiTutorRequestProgressPrimaryAction"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_request_progress_primary_action", "student_app_ai_tutor_request_progress_target_url"); assertReportPassed(studentTutor, "studentAppAiTutorRequestProgressTargetURL"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_request_progress_target_url", "student_app_ai_tutor_request_progress_refresh_policy"); assertReportPassed(studentTutor, "studentAppAiTutorRequestProgressRefreshPolicy"); assertRuntimeAfter(studentTutor, "student_app_ai_tutor_request_progress_refresh_policy", "student_app_ai_tutor_request_progress_conditional_cache"); assertReportPassed(studentTutor, "studentAppAiTutorRequestProgressConditionalCache");
...
function currentInputs() {
  return {
    ...
    reports: {
      ...
      [sourceReports.studentAppAiTutorResultStudentArchiveRowVerification]: JSON.stringify(readyRuntimeReport(5)),
      [sourceReports.studentAppAiTutorResultStudentArchiveRead]: JSON.stringify(readyRuntimeReport(5)),
      [sourceReports.studentAppAiTutorResultStudentArchiveRender]: JSON.stringify(readyRuntimeReport(5)),
      [sourceReports.studentAppAiTutorResultStudentArchiveLearningActions]: JSON.stringify(readyRuntimeReport(5)),
      [sourceReports.studentAppAiTutorWorkerResultArchiveInput]: JSON.stringify(readyRuntimeReport(5)),
      [sourceReports.studentAppAiTutorResultArchiveModelExecutionPrecheck]: JSON.stringify(readyRuntimeReport(6)), [sourceReports.studentAppAiTutorResultArchiveControlledAnswerArtifact]: JSON.stringify(readyRuntimeReport(6)), [sourceReports.studentAppAiTutorResultArchiveAnswerReviewGate]: JSON.stringify(readyRuntimeReport(6)), [sourceReports.studentAppAiTutorResultArchiveReviewedResultPersistenceBridge]: JSON.stringify(readyRuntimeReport(6)), [sourceReports.studentAppAiTutorResultArchiveStudentVisibilityReview]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorResultArchiveStudentDeliveryEnvelope]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorResultArchiveStudentArchivePersistenceCommand]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorResultArchiveStudentArchiveStorageCommit]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorResultArchiveStudentArchiveRowVerification]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorResultArchiveStudentArchiveRead]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorResultArchiveStudentArchiveRender]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorResultArchiveStudentArchiveLearningActions]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorResultArchiveFollowUpQueueAdmission]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorResultArchiveFollowUpWorkerContinuity]: JSON.stringify(readyRuntimeReport(6)), [sourceReports.studentAppAiTutorResultArchiveFollowUpDepthBudgetGuard]: JSON.stringify(readyRuntimeReport(6)), [sourceReports.studentAppAiTutorResultArchiveFollowUpQueueIdempotencyGuard]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorResultArchiveFollowUpLineageGuard]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorRequestProgressTimeline]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorRequestProgressDetail]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorRequestProgressPrimaryAction]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorRequestProgressTargetURL]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorRequestProgressRefreshPolicy]: JSON.stringify(readyRuntimeReport(5)), [sourceReports.studentAppAiTutorRequestProgressConditionalCache]: JSON.stringify(readyRuntimeReport(4)),
