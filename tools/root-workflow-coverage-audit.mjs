...
export const rootWorkflows = [
  ...
  },
  {
    ...
    reportChecks: [
      ...
      ["studentAppAiTutorResultArchiveModelExecutionPrecheck", "READY"], ["studentAppAiTutorQuestionBankFeedbackModelExecutionPrecheck", "READY"], ["studentAppAiTutorQuestionBankFeedbackControlledAnswerArtifact", "READY"],
    ...
    runtimeEvidence: [
      ...
      { name: "student_app_ai_tutor_result_archive_model_execution_precheck", reportKey: "studentAppAiTutorResultArchiveModelExecutionPrecheck", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_model_execution_precheck", reportKey: "studentAppAiTutorQuestionBankFeedbackModelExecutionPrecheck", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_controlled_answer_artifact", reportKey: "studentAppAiTutorQuestionBankFeedbackControlledAnswerArtifact", targetP99Ms: 50 },
