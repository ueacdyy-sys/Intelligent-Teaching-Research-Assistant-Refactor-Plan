...
export const sourceReports = {
  ...
  studentAppAiTutorResultArchiveModelExecutionPrecheck: "reports/student-app-ai-tutor-result-archive-model-execution-precheck.current.json", studentAppAiTutorQuestionBankFeedbackModelExecutionPrecheck: "reports/student-app-ai-tutor-question-bank-feedback-model-execution-precheck.current.json", studentAppAiTutorQuestionBankFeedbackControlledAnswerArtifact: "reports/student-app-ai-tutor-question-bank-feedback-controlled-answer-artifact.current.json", studentAppAiTutorQuestionBankFeedbackAnswerReviewGate: "reports/student-app-ai-tutor-question-bank-feedback-answer-review-gate.current.json", studentAppAiTutorQuestionBankFeedbackReviewedResultPersistenceBridge: "reports/student-app-ai-tutor-question-bank-feedback-reviewed-result-persistence-bridge.current.json", studentAppAiTutorQuestionBankFeedbackStudentVisibilityReview: "reports/student-app-ai-tutor-question-bank-feedback-student-visibility-review.current.json", studentAppAiTutorQuestionBankFeedbackStudentDeliveryEnvelope: "reports/student-app-ai-tutor-question-bank-feedback-student-delivery-envelope.current.json", studentAppAiTutorQuestionBankFeedbackStudentArchivePersistenceCommand: "reports/student-app-ai-tutor-question-bank-feedback-student-archive-persistence-command.current.json", studentAppAiTutorQuestionBankFeedbackStudentArchiveStorageCommit: "reports/student-app-ai-tutor-question-bank-feedback-student-archive-storage-commit.current.json", studentAppAiTutorQuestionBankFeedbackStudentArchiveRowVerification: "reports/student-app-ai-tutor-question-bank-feedback-student-archive-row-verification.current.json", studentAppAiTutorQuestionBankFeedbackStudentArchiveRead: "reports/student-app-ai-tutor-question-bank-feedback-student-archive-read.current.json",
...
export const rootWorkflows = [
  ...
  },
  {
    ...
    reportChecks: [
      ...
      ["studentAppAiTutorResultArchiveModelExecutionPrecheck", "READY"], ["studentAppAiTutorQuestionBankFeedbackModelExecutionPrecheck", "READY"], ["studentAppAiTutorQuestionBankFeedbackControlledAnswerArtifact", "READY"], ["studentAppAiTutorQuestionBankFeedbackAnswerReviewGate", "READY"], ["studentAppAiTutorQuestionBankFeedbackReviewedResultPersistenceBridge", "READY"], ["studentAppAiTutorQuestionBankFeedbackStudentVisibilityReview", "READY"], ["studentAppAiTutorQuestionBankFeedbackStudentDeliveryEnvelope", "READY"], ["studentAppAiTutorQuestionBankFeedbackStudentArchivePersistenceCommand", "READY"], ["studentAppAiTutorQuestionBankFeedbackStudentArchiveStorageCommit", "READY"], ["studentAppAiTutorQuestionBankFeedbackStudentArchiveRowVerification", "READY"], ["studentAppAiTutorQuestionBankFeedbackStudentArchiveRead", "READY"],
    ...
    runtimeEvidence: [
      ...
      { name: "student_app_ai_tutor_result_archive_model_execution_precheck", reportKey: "studentAppAiTutorResultArchiveModelExecutionPrecheck", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_model_execution_precheck", reportKey: "studentAppAiTutorQuestionBankFeedbackModelExecutionPrecheck", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_controlled_answer_artifact", reportKey: "studentAppAiTutorQuestionBankFeedbackControlledAnswerArtifact", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_answer_review_gate", reportKey: "studentAppAiTutorQuestionBankFeedbackAnswerReviewGate", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_reviewed_result_persistence_bridge", reportKey: "studentAppAiTutorQuestionBankFeedbackReviewedResultPersistenceBridge", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_student_visibility_review", reportKey: "studentAppAiTutorQuestionBankFeedbackStudentVisibilityReview", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_student_delivery_envelope", reportKey: "studentAppAiTutorQuestionBankFeedbackStudentDeliveryEnvelope", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_student_archive_persistence_command", reportKey: "studentAppAiTutorQuestionBankFeedbackStudentArchivePersistenceCommand", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_student_archive_storage_commit", reportKey: "studentAppAiTutorQuestionBankFeedbackStudentArchiveStorageCommit", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_student_archive_row_verification", reportKey: "studentAppAiTutorQuestionBankFeedbackStudentArchiveRowVerification", targetP99Ms: 50 }, { name: "student_app_ai_tutor_question_bank_feedback_student_archive_read", reportKey: "studentAppAiTutorQuestionBankFeedbackStudentArchiveRead", targetP99Ms: 50 },
