...
import { parsePsqlUnalignedRows } from "./identity-pgbouncer-diagnostics.mjs";
...
const postgresDiagnosticsQueries = {
  activity: `
...
export function collectPostgresDiagnostics(options, dependencies = {}) {
  ...
  const queries = Object.fromEntries(Object.entries(postgresDiagnosticsQueries).map(([name, sql]) => [
    name,
