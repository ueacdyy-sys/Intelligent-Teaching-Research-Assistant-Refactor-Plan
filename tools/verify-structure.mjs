...
function main() {
  ...
  const required0326 = [
    "docs/sdd/0326-student-app-ai-tutor-answer-review-gate.md",
    "tools/student-app-ai-tutor-answer-review-gate-runtime.mjs",
    "tools/student-app-ai-tutor-answer-review-gate-runtime.test.mjs",
    "tools/student-app-ai-tutor-answer-review-gate-audit.mjs",
    "tools/student-app-ai-tutor-answer-review-gate-audit.test.mjs",
  ];
  const required0327 = [
    "docs/sdd/0327-student-app-ai-tutor-reviewed-result-persistence-bridge.md",
    "tools/student-app-ai-tutor-reviewed-result-persistence-bridge-runtime.mjs",
    "tools/student-app-ai-tutor-reviewed-result-persistence-bridge-runtime.test.mjs",
    "tools/student-app-ai-tutor-reviewed-result-persistence-bridge-audit.mjs",
    "tools/student-app-ai-tutor-reviewed-result-persistence-bridge-audit.test.mjs",
  ];
  const required0328 = [
    "docs/sdd/0328-student-app-ai-tutor-result-student-visibility-review.md",
    "tools/student-app-ai-tutor-result-student-visibility-review-runtime.mjs",
    "tools/student-app-ai-tutor-result-student-visibility-review-runtime.test.mjs",
    "tools/student-app-ai-tutor-result-student-visibility-review-audit.mjs",
    "tools/student-app-ai-tutor-result-student-visibility-review-audit.test.mjs",
  ];
  const required0329 = ["docs/sdd/0329-student-app-ai-tutor-result-student-delivery-envelope.md", "tools/student-app-ai-tutor-result-student-delivery-envelope-runtime.mjs", "tools/student-app-ai-tutor-result-student-delivery-envelope-runtime.test.mjs", "tools/student-app-ai-tutor-result-student-delivery-envelope-audit.mjs", "tools/student-app-ai-tutor-result-student-delivery-envelope-audit.test.mjs"];
  const required0330 = ["docs/sdd/0330-student-app-ai-tutor-result-student-archive-persistence-command.md", "tools/student-app-ai-tutor-result-student-archive-persistence-command-runtime.mjs", "tools/student-app-ai-tutor-result-student-archive-persistence-command-runtime.test.mjs", "tools/student-app-ai-tutor-result-student-archive-persistence-command-audit.mjs", "tools/student-app-ai-tutor-result-student-archive-persistence-command-audit.test.mjs"];
  const required0331 = ["docs/sdd/0331-student-app-ai-tutor-result-student-archive-storage-commit.md", "tools/student-app-ai-tutor-result-student-archive-storage-commit-runtime.mjs", "tools/student-app-ai-tutor-result-student-archive-storage-commit-runtime.test.mjs", "tools/student-app-ai-tutor-result-student-archive-storage-commit-audit.mjs", "tools/student-app-ai-tutor-result-student-archive-storage-commit-audit.test.mjs"];
  const required0332 = ["docs/sdd/0332-student-app-ai-tutor-result-student-archive-row-verification.md", "tools/student-app-ai-tutor-result-student-archive-row-verification-runtime.mjs", "tools/student-app-ai-tutor-result-student-archive-row-verification-runtime.test.mjs", "tools/student-app-ai-tutor-result-student-archive-row-verification-audit.mjs", "tools/student-app-ai-tutor-result-student-archive-row-verification-audit.test.mjs"];
  const required0333 = ["docs/sdd/0333-student-app-ai-tutor-result-student-archive-read.md", "tools/student-app-ai-tutor-result-student-archive-read-runtime.mjs", "tools/student-app-ai-tutor-result-student-archive-read-runtime.test.mjs", "tools/student-app-ai-tutor-result-student-archive-read-audit.mjs", "tools/student-app-ai-tutor-result-student-archive-read-audit.test.mjs"];
  const required0334 = ["docs/sdd/0334-student-app-ai-tutor-result-student-archive-render.md", "tools/student-app-ai-tutor-result-student-archive-render-runtime.mjs", "tools/student-app-ai-tutor-result-student-archive-render-runtime.test.mjs", "tools/student-app-ai-tutor-result-student-archive-render-audit.mjs", "tools/student-app-ai-tutor-result-student-archive-render-audit.test.mjs"];
  const required0335 = ["docs/sdd/0335-student-app-ai-tutor-result-student-archive-learning-actions.md", "tools/student-app-ai-tutor-result-student-archive-learning-actions-runtime.mjs", "tools/student-app-ai-tutor-result-student-archive-learning-actions-runtime.test.mjs", "tools/student-app-ai-tutor-result-student-archive-learning-actions-audit.mjs", "tools/student-app-ai-tutor-result-student-archive-learning-actions-audit.test.mjs", "contracts/openapi/teaching-archive.student-app-archive-item-ai-tutor-result-learning-actions.path.yaml", "contracts/openapi/teaching-archive.student-app-ai-tutor-learning-action-source.schema.yaml", "services/teaching-archive-gateway/internal/domain/student_app_ai_tutor_result_archive_learning_actions.go", "services/teaching-archive-gateway/internal/domain/student_app_ai_tutor_result_archive_learning_actions_test.go", "services/teaching-archive-gateway/internal/usecase/read_student_app_ai_tutor_result_archive_learning_actions.go", "services/teaching-archive-gateway/internal/usecase/read_student_app_ai_tutor_result_archive_learning_actions_test.go"];
  const required0336 = ["docs/sdd/0336-student-app-ai-tutor-worker-result-archive-input.md", "tools/student-app-ai-tutor-worker-result-archive-input-audit.mjs", "tools/student-app-ai-tutor-worker-result-archive-input-audit.test.mjs"];
  const required0337 = ["docs/sdd/0337-student-app-ai-tutor-result-archive-model-execution-precheck.md", "tools/student-app-ai-tutor-result-archive-model-execution-precheck-audit.mjs", "tools/student-app-ai-tutor-result-archive-model-execution-precheck-audit.test.mjs"];
  const required0338 = ["docs/sdd/0338-student-app-ai-tutor-result-archive-controlled-answer-artifact.md", "tools/student-app-ai-tutor-result-archive-controlled-answer-artifact-audit.mjs", "tools/student-app-ai-tutor-result-archive-controlled-answer-artifact-audit.test.mjs"]; const required0339 = ["docs/sdd/0339-student-app-ai-tutor-result-archive-answer-review-gate.md", "tools/student-app-ai-tutor-result-archive-answer-review-gate-audit.mjs", "tools/student-app-ai-tutor-result-archive-answer-review-gate-audit.test.mjs"]; const required0340 = ["docs/sdd/0340-student-app-ai-tutor-result-archive-reviewed-result-persistence-bridge.md", "tools/student-app-ai-tutor-result-archive-reviewed-result-persistence-bridge-audit.mjs", "tools/student-app-ai-tutor-result-archive-reviewed-result-persistence-bridge-audit.test.mjs"]; const required0341 = ["docs/sdd/0341-student-app-ai-tutor-result-archive-student-visibility-review.md", "tools/student-app-ai-tutor-result-archive-student-visibility-review-audit.mjs", "tools/student-app-ai-tutor-result-archive-student-visibility-review-audit.test.mjs"]; const required0342 = ["docs/sdd/0342-student-app-ai-tutor-result-archive-student-delivery-envelope.md", "tools/student-app-ai-tutor-result-archive-student-delivery-envelope-audit.mjs", "tools/student-app-ai-tutor-result-archive-student-delivery-envelope-audit.test.mjs"]; const required0343 = ["docs/sdd/0343-student-app-ai-tutor-result-archive-student-archive-persistence-command.md", "tools/student-app-ai-tutor-result-archive-student-archive-persistence-command-audit.mjs", "tools/student-app-ai-tutor-result-archive-student-archive-persistence-command-audit.test.mjs"]; const required0344 = ["docs/sdd/0344-student-app-ai-tutor-result-archive-student-archive-storage-commit.md", "tools/student-app-ai-tutor-result-archive-student-archive-storage-commit-audit.mjs", "tools/student-app-ai-tutor-result-archive-student-archive-storage-commit-audit.test.mjs"]; const required0345 = ["docs/sdd/0345-student-app-ai-tutor-result-archive-student-archive-row-verification.md", "tools/student-app-ai-tutor-result-archive-student-archive-row-verification-audit.mjs", "tools/student-app-ai-tutor-result-archive-student-archive-row-verification-audit.test.mjs"]; const required0346 = ["docs/sdd/0346-student-app-ai-tutor-result-archive-student-archive-read.md", "tools/student-app-ai-tutor-result-archive-student-archive-read-audit.mjs", "tools/student-app-ai-tutor-result-archive-student-archive-read-audit.test.mjs"]; const required0347 = ["docs/sdd/0347-student-app-ai-tutor-result-archive-student-archive-render.md", "tools/student-app-ai-tutor-result-archive-student-archive-render-audit.mjs", "tools/student-app-ai-tutor-result-archive-student-archive-render-audit.test.mjs"]; const required0348 = ["docs/sdd/0348-student-app-ai-tutor-result-archive-student-archive-learning-actions.md", "tools/student-app-ai-tutor-result-archive-student-archive-learning-actions-audit.mjs", "tools/student-app-ai-tutor-result-archive-student-archive-learning-actions-audit.test.mjs"]; const required0349 = ["docs/sdd/0349-student-app-ai-tutor-result-archive-follow-up-queue-admission.md", "tools/student-app-ai-tutor-result-archive-follow-up-queue-admission-audit.mjs", "tools/student-app-ai-tutor-result-archive-follow-up-queue-admission-audit.test.mjs"]; const required0350 = ["docs/sdd/0350-student-app-ai-tutor-result-archive-follow-up-worker-continuity.md", "tools/student-app-ai-tutor-result-archive-follow-up-worker-continuity-audit.mjs", "tools/student-app-ai-tutor-result-archive-follow-up-worker-continuity-audit.test.mjs"]; const required0351 = ["docs/sdd/0351-student-app-ai-tutor-result-archive-follow-up-depth-budget-guard.md", "tools/student-app-ai-tutor-result-archive-follow-up-depth-budget-guard-audit.mjs", "tools/student-app-ai-tutor-result-archive-follow-up-depth-budget-guard-audit.test.mjs"]; const required0352 = ["docs/sdd/0352-student-app-ai-tutor-result-archive-follow-up-queue-idempotency-guard.md", "tools/student-app-ai-tutor-result-archive-follow-up-queue-idempotency-guard-audit.mjs", "tools/student-app-ai-tutor-result-archive-follow-up-queue-idempotency-guard-audit.test.mjs"]; const required0353 = ["docs/sdd/0353-student-app-ai-tutor-result-archive-follow-up-lineage-guard.md", "tools/student-app-ai-tutor-result-archive-follow-up-lineage-guard-audit.mjs", "tools/student-app-ai-tutor-result-archive-follow-up-lineage-guard-audit.test.mjs"]; const required0354 = ["docs/sdd/0354-student-app-ai-tutor-request-progress-timeline.md", "tools/student-app-ai-tutor-request-progress-timeline-audit.mjs", "tools/student-app-ai-tutor-request-progress-timeline-audit.test.mjs"]; const required0355 = ["docs/sdd/0355-student-app-ai-tutor-request-progress-detail.md", "tools/student-app-ai-tutor-request-progress-detail-audit.mjs", "tools/student-app-ai-tutor-request-progress-detail-audit.test.mjs", "contracts/openapi/teaching-archive.student-app-ai-tutor-request.path.yaml", "services/teaching-archive-gateway/internal/usecase/read_student_app_ai_tutor_request_progress.go", "services/teaching-archive-gateway/internal/usecase/read_student_app_ai_tutor_request_progress_test.go"]; const required0356 = ["docs/sdd/0356-student-app-ai-tutor-request-progress-primary-action.md", "tools/student-app-ai-tutor-request-progress-primary-action-audit.mjs", "tools/student-app-ai-tutor-request-progress-primary-action-audit.test.mjs"]; const required0357 = ["docs/sdd/0357-student-app-ai-tutor-request-progress-target-url.md", "tools/student-app-ai-tutor-request-progress-target-url-audit.mjs", "tools/student-app-ai-tutor-request-progress-target-url-audit.test.mjs"]; const required0358 = ["docs/sdd/0358-student-app-ai-tutor-request-progress-refresh-policy.md", "tools/student-app-ai-tutor-request-progress-refresh-policy-audit.mjs", "tools/student-app-ai-tutor-request-progress-refresh-policy-audit.test.mjs"]; const required0359 = ["docs/sdd/0359-student-app-ai-tutor-request-progress-conditional-cache.md", "tools/student-app-ai-tutor-request-progress-conditional-cache-audit.mjs", "tools/student-app-ai-tutor-request-progress-conditional-cache-audit.test.mjs"]; const required0360 = ["docs/sdd/0360-student-app-ai-tutor-request-progress-preencode-validator.md", "tools/student-app-ai-tutor-request-progress-preencode-validator-audit.mjs", "tools/student-app-ai-tutor-request-progress-preencode-validator-audit.test.mjs"]; const required0361 = ["docs/sdd/0361-student-app-ai-tutor-request-progress-summary.md", "tools/student-app-ai-tutor-request-progress-summary-audit.mjs", "tools/student-app-ai-tutor-request-progress-summary-audit.test.mjs"]; const required0362 = ["docs/sdd/0362-student-app-ai-tutor-request-progress-view-filter.md", "tools/student-app-ai-tutor-request-progress-view-filter-audit.mjs", "tools/student-app-ai-tutor-request-progress-view-filter-audit.test.mjs"];
  const required0363 = ["docs/sdd/0363-student-app-ai-tutor-request-progress-summary-count.md", "tools/student-app-ai-tutor-request-progress-summary-count-audit.mjs", "tools/student-app-ai-tutor-request-progress-summary-count-audit.test.mjs", "contracts/openapi/teaching-archive.student-app-ai-tutor-request-progress-summary.path.yaml", "services/teaching-archive-gateway/internal/usecase/read_student_app_ai_tutor_request_progress_summary.go", "services/teaching-archive-gateway/internal/usecase/read_student_app_ai_tutor_request_progress_summary_test.go", "services/teaching-archive-gateway/internal/adapter/postgres/repository_tutoring_analysis_progress_summary_count_test.go"]; required0354.push("contracts/openapi/teaching-archive.student-app-ai-tutor-request-progress.schema.yaml"); const required0364 = ["docs/sdd/0364-student-app-archive-items-search-summary.md", "contracts/openapi/teaching-archive.student-app-archive-items-summary.path.yaml", "contracts/openapi/teaching-archive.student-app-archive-items-summary.schema.yaml", "services/teaching-archive-gateway/internal/usecase/read_student_app_archive_item_search_summary.go", "services/teaching-archive-gateway/internal/usecase/read_student_app_archive_item_search_summary_test.go", "services/teaching-archive-gateway/internal/adapter/postgres/repository_published_archive_material_search_summary_count_test.go", "services/teaching-archive-gateway/internal/adapter/httpapi/server_student_app_archive_item_search_summary_presenter.go", "services/teaching-archive-gateway/internal/adapter/httpapi/server_student_app_archive_item_search_summary_validator.go"];
  ...
  const required0326RuntimeEvidence = "student_app_ai_tutor_answer_review_gate_runtime";
  const required0327RuntimeEvidence = "student_app_ai_tutor_reviewed_result_persistence_bridge_runtime";
  const required0328RuntimeEvidence = "student_app_ai_tutor_result_student_visibility_review_runtime";
  const required0329RuntimeEvidence = "student_app_ai_tutor_result_student_delivery_envelope_runtime";
  const required0330RuntimeEvidence = "student_app_ai_tutor_result_student_archive_persistence_command_runtime";
  const required0331RuntimeEvidence = "student_app_ai_tutor_result_student_archive_storage_commit_runtime";
  const required0332RuntimeEvidence = "student_app_ai_tutor_result_student_archive_row_verification_runtime";
  const required0333RuntimeEvidence = "student_app_ai_tutor_result_student_archive_read_runtime";
  const required0334RuntimeEvidence = "student_app_ai_tutor_result_student_archive_render_runtime";
  const required0335RuntimeEvidence = "student_app_ai_tutor_result_student_archive_learning_actions_runtime";
  const required0336RuntimeEvidence = "student_app_ai_tutor_worker_result_archive_input";
  const required0337RuntimeEvidence = "student_app_ai_tutor_result_archive_model_execution_precheck";
  const required0338RuntimeEvidence = "student_app_ai_tutor_result_archive_controlled_answer_artifact"; const required0339RuntimeEvidence = "student_app_ai_tutor_result_archive_answer_review_gate"; const required0340RuntimeEvidence = "student_app_ai_tutor_result_archive_reviewed_result_persistence_bridge"; const required0341RuntimeEvidence = "student_app_ai_tutor_result_archive_student_visibility_review"; const required0342RuntimeEvidence = "student_app_ai_tutor_result_archive_student_delivery_envelope"; const required0343RuntimeEvidence = "student_app_ai_tutor_result_archive_student_archive_persistence_command"; const required0344RuntimeEvidence = "student_app_ai_tutor_result_archive_student_archive_storage_commit"; const required0345RuntimeEvidence = "student_app_ai_tutor_result_archive_student_archive_row_verification"; const required0346RuntimeEvidence = "student_app_ai_tutor_result_archive_student_archive_read"; const required0347RuntimeEvidence = "student_app_ai_tutor_result_archive_student_archive_render"; const required0348RuntimeEvidence = "student_app_ai_tutor_result_archive_student_archive_learning_actions"; const required0349RuntimeEvidence = "student_app_ai_tutor_result_archive_follow_up_queue_admission"; const required0350RuntimeEvidence = "student_app_ai_tutor_result_archive_follow_up_worker_continuity"; const required0351RuntimeEvidence = "student_app_ai_tutor_result_archive_follow_up_depth_budget_guard"; const required0352RuntimeEvidence = "student_app_ai_tutor_result_archive_follow_up_queue_idempotency_guard"; const required0353RuntimeEvidence = "student_app_ai_tutor_result_archive_follow_up_lineage_guard"; const required0354RuntimeEvidence = "student_app_ai_tutor_request_progress_timeline"; const required0355RuntimeEvidence = "student_app_ai_tutor_request_progress_detail"; const required0356RuntimeEvidence = "student_app_ai_tutor_request_progress_primary_action"; const required0357RuntimeEvidence = "student_app_ai_tutor_request_progress_target_url"; const required0358RuntimeEvidence = "student_app_ai_tutor_request_progress_refresh_policy"; const required0359RuntimeEvidence = "student_app_ai_tutor_request_progress_conditional_cache"; const required0360RuntimeEvidence = "student_app_ai_tutor_request_progress_preencode_validator"; const required0361RuntimeEvidence = "student_app_ai_tutor_request_progress_summary"; const required0362RuntimeEvidence = "student_app_ai_tutor_request_progress_view_filter"; const required0363RuntimeEvidence = "student_app_ai_tutor_request_progress_summary_count";
  const missing = [...required, ...required0302, ...required0303, ...required0304, ...required0305, ...required0306, ...required0307, ...required0308, ...required0309, ...required0310, ...required0311, ...required0312, ...required0313, ...required0314, ...required0315, ...required0316, ...required0317, ...required0318, ...required0319, ...required0320, ...required0321, ...required0322, ...required0323, ...required0324, ...required0325, ...required0326, ...required0327, ...required0328, ...required0329, ...required0330, ...required0331, ...required0332, ...required0333, ...required0334, ...required0335, ...required0336, ...required0337, ...required0338, ...required0339, ...required0340, ...required0341, ...required0342, ...required0343, ...required0344, ...required0345, ...required0346, ...required0347, ...required0348, ...required0349, ...required0350, ...required0351, ...required0352, ...required0353, ...required0354, ...required0355, ...required0356, ...required0357, ...required0358, ...required0359, ...required0360, ...required0361, ...required0362, ...required0363, ...required0364].filter((file) => !fs.existsSync(path.join(root, file)));
  if (missing.length > 0) {
  ...
  for (const [slice, file, evidence] of [
    ["0322 student app ai tutor published learning action source", "tools/student-app-ai-tutor-published-learning-action-source-audit.mjs", required0322RuntimeEvidence],
    ["0323 student app ai tutor worker study packet input", "tools/student-app-ai-tutor-worker-study-packet-input-audit.mjs", required0323RuntimeEvidence],
    ["0324 student app ai tutor model execution precheck", "tools/student-app-ai-tutor-model-execution-precheck-runtime.mjs", required0324RuntimeEvidence],
    ["0325 student app ai tutor controlled answer artifact", "tools/student-app-ai-tutor-controlled-answer-artifact-runtime.mjs", required0325RuntimeEvidence],
    ["0326 student app ai tutor answer review gate", "tools/student-app-ai-tutor-answer-review-gate-runtime.mjs", required0326RuntimeEvidence],
    ["0327 student app ai tutor reviewed result persistence bridge", "tools/student-app-ai-tutor-reviewed-result-persistence-bridge-runtime.mjs", required0327RuntimeEvidence],
    ["0328 student app ai tutor result student visibility review", "tools/student-app-ai-tutor-result-student-visibility-review-runtime.mjs", required0328RuntimeEvidence],
    ["0329 student app ai tutor result student delivery envelope", "tools/student-app-ai-tutor-result-student-delivery-envelope-runtime.mjs", required0329RuntimeEvidence],
    ["0330 student app ai tutor result student archive persistence command", "tools/student-app-ai-tutor-result-student-archive-persistence-command-runtime.mjs", required0330RuntimeEvidence],
    ["0331 student app ai tutor result student archive storage commit", "tools/student-app-ai-tutor-result-student-archive-storage-commit-runtime.mjs", required0331RuntimeEvidence],
    ["0332 student app ai tutor result student archive row verification", "tools/student-app-ai-tutor-result-student-archive-row-verification-runtime.mjs", required0332RuntimeEvidence],
    ["0333 student app ai tutor result student archive read", "tools/student-app-ai-tutor-result-student-archive-read-runtime.mjs", required0333RuntimeEvidence],
    ["0334 student app ai tutor result student archive render", "tools/student-app-ai-tutor-result-student-archive-render-runtime.mjs", required0334RuntimeEvidence],
    ["0335 student app ai tutor result student archive learning actions", "tools/student-app-ai-tutor-result-student-archive-learning-actions-runtime.mjs", required0335RuntimeEvidence],
    ["0336 student app ai tutor worker result archive input", "tools/student-app-ai-tutor-worker-result-archive-input-audit.mjs", required0336RuntimeEvidence],
    ["0337 student app ai tutor result archive model execution precheck", "tools/student-app-ai-tutor-result-archive-model-execution-precheck-audit.mjs", required0337RuntimeEvidence],
    ["0338 student app ai tutor result archive controlled answer artifact", "tools/student-app-ai-tutor-result-archive-controlled-answer-artifact-audit.mjs", required0338RuntimeEvidence], ["0339 student app ai tutor result archive answer review gate", "tools/student-app-ai-tutor-result-archive-answer-review-gate-audit.mjs", required0339RuntimeEvidence], ["0340 student app ai tutor result archive reviewed result persistence bridge", "tools/student-app-ai-tutor-result-archive-reviewed-result-persistence-bridge-audit.mjs", required0340RuntimeEvidence], ["0341 student app ai tutor result archive student visibility review", "tools/student-app-ai-tutor-result-archive-student-visibility-review-audit.mjs", required0341RuntimeEvidence], ["0342 student app ai tutor result archive student delivery envelope", "tools/student-app-ai-tutor-result-archive-student-delivery-envelope-audit.mjs", required0342RuntimeEvidence], ["0343 student app ai tutor result archive student archive persistence command", "tools/student-app-ai-tutor-result-archive-student-archive-persistence-command-audit.mjs", required0343RuntimeEvidence], ["0344 student app ai tutor result archive student archive storage commit", "tools/student-app-ai-tutor-result-archive-student-archive-storage-commit-audit.mjs", required0344RuntimeEvidence], ["0345 student app ai tutor result archive student archive row verification", "tools/student-app-ai-tutor-result-archive-student-archive-row-verification-audit.mjs", required0345RuntimeEvidence], ["0346 student app ai tutor result archive student archive read", "tools/student-app-ai-tutor-result-archive-student-archive-read-audit.mjs", required0346RuntimeEvidence], ["0347 student app ai tutor result archive student archive render", "tools/student-app-ai-tutor-result-archive-student-archive-render-audit.mjs", required0347RuntimeEvidence], ["0348 student app ai tutor result archive student archive learning actions", "tools/student-app-ai-tutor-result-archive-student-archive-learning-actions-audit.mjs", required0348RuntimeEvidence], ["0349 student app ai tutor result archive follow-up queue admission", "tools/student-app-ai-tutor-result-archive-follow-up-queue-admission-audit.mjs", required0349RuntimeEvidence], ["0350 student app ai tutor result archive follow-up worker continuity", "tools/student-app-ai-tutor-result-archive-follow-up-worker-continuity-audit.mjs", required0350RuntimeEvidence], ["0351 student app ai tutor result archive follow-up depth budget guard", "tools/student-app-ai-tutor-result-archive-follow-up-depth-budget-guard-audit.mjs", required0351RuntimeEvidence], ["0352 student app ai tutor result archive follow-up queue idempotency guard", "tools/student-app-ai-tutor-result-archive-follow-up-queue-idempotency-guard-audit.mjs", required0352RuntimeEvidence], ["0353 student app ai tutor result archive follow-up lineage guard", "tools/student-app-ai-tutor-result-archive-follow-up-lineage-guard-audit.mjs", required0353RuntimeEvidence], ["0354 student app ai tutor request progress timeline", "tools/student-app-ai-tutor-request-progress-timeline-audit.mjs", required0354RuntimeEvidence], ["0355 student app ai tutor request progress detail", "tools/student-app-ai-tutor-request-progress-detail-audit.mjs", required0355RuntimeEvidence], ["0356 student app ai tutor request progress primary action", "tools/student-app-ai-tutor-request-progress-primary-action-audit.mjs", required0356RuntimeEvidence], ["0357 student app ai tutor request progress target url", "tools/student-app-ai-tutor-request-progress-target-url-audit.mjs", required0357RuntimeEvidence], ["0358 student app ai tutor request progress refresh policy", "tools/student-app-ai-tutor-request-progress-refresh-policy-audit.mjs", required0358RuntimeEvidence], ["0359 student app ai tutor request progress conditional cache", "tools/student-app-ai-tutor-request-progress-conditional-cache-audit.mjs", required0359RuntimeEvidence], ["0360 student app ai tutor request progress pre-encode validator", "tools/student-app-ai-tutor-request-progress-preencode-validator-audit.mjs", required0360RuntimeEvidence], ["0361 student app ai tutor request progress summary", "tools/student-app-ai-tutor-request-progress-summary-audit.mjs", required0361RuntimeEvidence], ["0362 student app ai tutor request progress view filter", "tools/student-app-ai-tutor-request-progress-view-filter-audit.mjs", required0362RuntimeEvidence], ["0363 student app ai tutor request progress summary count", "tools/student-app-ai-tutor-request-progress-summary-count-audit.mjs", required0363RuntimeEvidence],
  ]) if (!fs.readFileSync(path.join(root, file), "utf8").includes(evidence)) fail(`${slice} runtime id is missing.`);
