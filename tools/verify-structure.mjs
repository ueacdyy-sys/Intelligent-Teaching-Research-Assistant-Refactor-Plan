...
const required = [
  ...
  "docs/sdd/0063-student-app-ai-tutor-requests-list.md", "docs/sdd/0064-student-app-quiz-submissions-list.md",
  ...
  "services/teaching-archive-gateway/internal/domain/student_app_quiz_submissions.go", "services/teaching-archive-gateway/internal/domain/student_app_quiz_submissions_test.go",
  ...
  "services/teaching-archive-gateway/internal/usecase/list_student_app_quiz_submissions.go", "services/teaching-archive-gateway/internal/usecase/list_student_app_quiz_submissions_test.go",
  ...
  "services/teaching-archive-gateway/internal/adapter/httpapi/server_student_app_quiz_submissions.go", "services/teaching-archive-gateway/internal/adapter/httpapi/server_student_app_quiz_submissions_test.go",
...
for (const [id, file] of [
  ...
  ["0063", "0063-student-app-ai-tutor-requests-list.md"], ["0064", "0064-student-app-quiz-submissions-list.md"],
]) {
