...
const required = [
  ...
  "tools/quality-gate.test.mjs", "tools/student-app-flow-audit.mjs", "tools/student-app-flow-audit.test.mjs", "tools/agent-harness-flow-audit.mjs", "tools/agent-harness-flow-audit.test.mjs", "tools/workflow-plugin-flow-audit.mjs", "tools/workflow-plugin-flow-audit.test.mjs", "tools/workflow-plugin-registry-admission.mjs", "tools/workflow-plugin-registry-admission.test.mjs", "tools/workflow-plugin-revision-feedback.mjs", "tools/workflow-plugin-revision-feedback.test.mjs", "tools/ai-worker-job-audit.mjs", "tools/ai-worker-job-audit.test.mjs", "tools/verify-structure-sdd-discovery.test.mjs",
