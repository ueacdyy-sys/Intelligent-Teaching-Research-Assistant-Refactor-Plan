...
`,
  ...
  it("plans tests, vet, contract audits, and connection budgets", () => {
    ...
    assert.deepEqual(commands, [
      ...
      "Student App AI Tutor question-bank-feedback reviewed result persistence bridge audit",
      ...
      "Student App AI Tutor result-archive student visibility review audit",
      "Student App AI Tutor result-archive student delivery envelope audit",
      "Student App AI Tutor result-archive student archive persistence command audit",
      "Student App AI Tutor result-archive student archive storage commit audit",
      "Student App AI Tutor result-archive student archive row verification audit",
      "Student App AI Tutor result-archive student archive read audit",
      "Student App AI Tutor result-archive student archive render audit",
      "Student App AI Tutor result-archive student archive learning actions audit",
      "Student App AI Tutor result-archive follow-up queue admission audit",
      "Student App AI Tutor result-archive follow-up worker continuity audit",
      "Student App AI Tutor result-archive follow-up depth/budget guard audit",
