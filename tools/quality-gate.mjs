...
export function buildQualityCommandPlan() {
  return [
    ...
    { name: "Student App AI Tutor question-bank-feedback answer review gate audit", command: npmCommand(), args: ["run", "audit:student-app-ai-tutor-question-bank-feedback-answer-review-gate"] },
    { name: "Student App AI Tutor question-bank-feedback reviewed result persistence bridge audit", command: npmCommand(), args: ["run", "audit:student-app-ai-tutor-question-bank-feedback-reviewed-result-persistence-bridge"] },
    { name: "Student App AI Tutor question-bank-feedback student visibility review audit", command: npmCommand(), args: ["run", "audit:student-app-ai-tutor-question-bank-feedback-student-visibility-review"] },
    { name: "Student App AI Tutor question-bank-feedback student delivery envelope audit", command: npmCommand(), args: ["run", "audit:student-app-ai-tutor-question-bank-feedback-student-delivery-envelope"] },
    ...
    { name: "Student App AI Tutor request progress summary audit", command: npmCommand(), args: ["run", "audit:student-app-ai-tutor-request-progress-summary"] },
    { name: "Student App AI Tutor request progress view filter audit", command: npmCommand(), args: ["run", "audit:student-app-ai-tutor-request-progress-view-filter"] },
    { name: "Student App AI Tutor request progress summary count audit", command: npmCommand(), args: ["run", "audit:student-app-ai-tutor-request-progress-summary-count"] },
