...
func TestListStudentAppArchiveItemsScopesOwnStudentBeforeRepository(t *testing.T) {
	reader := &fakeReader{
	...
	if reader.query.OwnerType != domain.OwnerTypeStudent {
	...
	if reader.query.MaterialType != domain.MaterialTypeQuiz {
