...
func main() {
	...
	readStudentAppArchiveItemSearchSummary := usecase.NewReadStudentAppArchiveItemSearchSummary(archiveRepository)
	...
	renderStudentAppAITutorResultArchive := usecase.NewRenderStudentAppAITutorResultArchive(readStudentAppAITutorResultArchive)
	...
	server := &http.Server{
		...
		Handler: httpapi.NewServer(httpapi.ServerConfig{
			...
			ReadStudentAppArchiveItemSearchSummary:                       readStudentAppArchiveItemSearchSummary,
			...
			RenderStudentAppAITutorResultArchive:                         renderStudentAppAITutorResultArchive,
			...
			RenderStudentAppQuestionBankDraftAnswerFeedback:              renderStudentAppQuestionBankDraftAnswerFeedback,
			ReadStudentAppQuestionBankDraftAnswerFeedbackLearningActions: readStudentAppQuestionBankDraftAnswerFeedbackLearningActions,
